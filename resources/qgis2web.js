...
map.getView().fit([12261648.990305, -896304.175054, 12308418.616885, -865582.071783], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Umur 20-24 tahun  Kabupaten Bantul</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (280 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta umur merupakan peta tematik yang menyajikan informasi mengenai persebaran penduduk berdasarkan kelompok umur pada wilayah Bantul. Pembuatan peta ini bertujuan untuk memvisualisasikan distribusi umur penduduk sehingga dapat memberikan gambaran mengenai karakteristik demografi';
            }
